...
@Composable
fun ProviderVerificationsOptionCard(
    label: String,
    selectedOption: ProvidersVerificationOptions,
    onSelect: (selectedOptions: ProvidersVerificationOptions) -> Unit
){
    Column(
        modifier = Modifier
            .fillMaxWidth()
        ...
        ContainerBorderedCard(
            ...
            Column(
                ...
                ProvidersVerificationOptions.listValue.forEach {
                    OptionItem(
                        label = it.label,
