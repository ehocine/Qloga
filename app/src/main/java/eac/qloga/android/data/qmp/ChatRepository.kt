...
class ChatRepository(private val apiService: ChatApi){
    ...
    suspend fun addP2PMessage(pid: Long,message: ChatMessage) = apiService.addP2PMessage(pid, message)
    ...
    suspend fun getGroupMessages(id: Long,page: Long,psize: Long) = apiService.getGroupMessages(id, page, psize)
