...
class AlbumsRepository(@QLOGAApiService private val apiService: AlbumsApi) {
    ...
    suspend fun moveMediaBetweenAlbums(mid: Long, aid: Long) =
        apiService.moveMediaBetweenAlbums(mid, aid)
