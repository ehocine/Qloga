...
class FamilliesRepository(@QLOGAApiService private val apiService: FamiliesApi) {
    //Families
    ...
    suspend fun updateRelative(kin: FamilyRole, startDate: ZonedDateTime, person: Person) =
        apiService.updateRelative(kin, startDate.dateToString(), person)
